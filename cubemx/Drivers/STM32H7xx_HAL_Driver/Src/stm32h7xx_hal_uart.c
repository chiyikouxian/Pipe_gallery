/**
 ...
 ===============================================================================
  [..]
    ...
    [..]
    (@) These API's (HAL_uart4_init(), HAL_HalfDuplex_Init(), HAL_LIN_Init(), HAL_MultiProcessor_Init(),
    ...
    [..]
    By default, after the HAL_uart4_init() and when the state is HAL_UART_STATE_RESET
    all callbacks are set to the corresponding weak functions:
    examples HAL_UART_TxCpltCallback(), HAL_UART_RxHalfCpltCallback().
    Exception done for MspInit and MspDeInit functions that are respectively
    reset to the legacy weak functions in the HAL_uart4_init()
    and HAL_UART_DeInit() only when these callbacks are null (not registered beforehand).
    If not, MspInit or MspDeInit are not null, the HAL_uart4_init() and HAL_UART_DeInit()
...
===============================================================================
 ...
 ===============================================================================
    ...
    [..]
    The HAL_uart4_init(), HAL_HalfDuplex_Init(), HAL_LIN_Init()and HAL_MultiProcessor_Init()API
...
/**
  ...
  *        parameters in the uart4_initTypeDef and initialize the associated handle.
  * @param huart UART handle.
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_uart4_init(UART_HandleTypeDef *huart)
{
  ...
  if (huart->gState == HAL_UART_STATE_RESET)
  {
    ...
    uart4_initCallbacksToDefault(huart);
...
/**
  ...
  *        parameters in the uart4_initTypeDef and creates the associated handle.
  * @param huart UART handle.
  * @retval HAL status
  */
...
/**
  ...
  * @note   The HAL_UART_RegisterCallback() may be called before HAL_uart4_init(), HAL_HalfDuplex_Init(),
...
/**
  ...
  * @note   The HAL_UART_UnRegisterCallback() may be called before HAL_uart4_init(), HAL_HalfDuplex_Init(),
...
/**
  ...
  */
#if (USE_HAL_UART_REGISTER_CALLBACKS == 1)
void uart4_initCallbacksToDefault(UART_HandleTypeDef *huart)
{
