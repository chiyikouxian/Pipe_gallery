...
ErrorStatus LL_LPuart4_init(USART_TypeDef *LPUARTx, const LL_LPuart4_initTypeDef *LPuart4_initStruct);
void        LL_LPUART_StructInit(LL_LPuart4_initTypeDef *LPuart4_initStruct);
/**
  * @}
  */
#endif /* USE_FULL_LL_DRIVER */
